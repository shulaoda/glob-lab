...
fn glob_match_crate(b: &mut Criterion) {
  b.bench_function("glob_match_crate", |b| b.iter(|| assert!(glob_match::glob_match(GLOB, PATH))));
}

criterion_group!(benches, globset_crate, glob_crate, glob_match_crate, mine_crate);
